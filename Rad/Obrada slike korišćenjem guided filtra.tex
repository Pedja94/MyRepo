...
{\LARGE Univerzitet u Nišu}\\[1.5cm] % Name of your university/college
{\Large Elektronski fakultet}\\[0.5cm] % Major heading such as course name
{\large Smer računarstvo i informatika}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Obrada slike i guided filter}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textbf{Mentor:} \\
Dr. Dejan Rančić % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
...
\caption{Snimak sa zamagljenjem}
\label{overflow}
\end{figure}   
...
\caption{Rezultat filtriranja magle na predhodnoj slici}
\label{overflow}
\end{figure}   
